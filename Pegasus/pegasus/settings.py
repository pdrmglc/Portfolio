...
SECRET_KEY = 'django-insecure-fa$6wr0*%1-mpfrrq8k=fau@8em5o9=v)@sj=ixvw6xn$i#wnn'
...
MEDIA_ROOT =  Path.joinpath(BASE_DIR, 'media')  # Caminho absoluto para a pasta "media"
